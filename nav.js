...
// Links use directory URLs (/applications/) so the browser does not show …/index.html.
const NAV_HTML = `
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="/#web-work"
             role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Work
          </a>
          <ul class="dropdown-menu dropdown-menu-dark dropdown-glass">
            <li><a class="dropdown-item" href="/web-work/">Web Work</a></li>
